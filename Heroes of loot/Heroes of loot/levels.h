...
public:
	...
	void RandomBonuses(const char *name_bonus, int numb_bonus);
	...
	void DrawDynamicSprite(sf::RenderWindow &window, sf::Sprite &sprite, int left, int top, int w, int h, float time, int x, int y, float &current_frame);
private:
...
void Level::DrawDynamicSprite(sf::RenderWindow &window, sf::Sprite &sprite, int left, int top, int w, int h, float time, int x, int y, float &current_frame)
{
